...
#+STARTUP: overview
#+PROPERTY: header-args:emacs-lisp :tangle ~/dotconfig/basic/editor/emacs/default/init.el
...
** Auto-refile completed tasks to daily note
#+begin_src emacs-lisp
...
*Features:*
- Daily notes with structured reflection templates
- Project management with automatic org-agenda integration
- Multiple capture templates: default, literature, meetings, concepts, references
- Consult integration for enhanced search and navigation
- Visual knowledge graph with org-roam-ui
- Automatic refile target management
- Year/month planning notes
- Completed task archival to daily notes

*Directory Structure:*
- =~/org/notes/=          - Main directory
- =~/org/notes/daily/=    - Daily journal notes
- =~/org/notes/projects/= - Project files (added to org-agenda)
- =~/org/notes/meetings/= - Meeting notes
- =~/org/notes/concepts/= - Concept definitions
- =~/org/notes/lit/=      - Literature notes
...
4. **Literature Notes**: Structured templates for reading and research notes
